...
class Parser( object ):
   ...
   def Defenition( self ):
      ...
      self.Expect(1)
      name = self.token.val; end_pos = self.token.pos 
      params = self.Params()
      self.Expect(4)
      type = self.Type()
   ...
   def Primary( self ):
      if self.la.kind == 1:
         self.Get( )
         prim = Node(value=self.token.val, t='IDENTIFIER', start_pos=(self.token.pos - len(self.token.val)), end_pos=self.token.pos) 
      elif self.la.kind == 3:
         self.Get( )
         prim = Node(value=self.token.val, t='STRING', start_pos=(self.token.pos - len(self.token.val)), end_pos=self.token.pos) 
      elif self.la.kind == 2:
         self.Get( )
         prim = Node(value=self.token.val, t='CONSTANTS', start_pos=(self.token.pos - len(self.token.val)), end_pos=self.token.pos) 
      elif self.la.kind == 5:
         self.Get( )
         start_pos = self.token.pos 
         tree = self.Expression()
   ...
   def FunctionCall( self ):
      res = Node(value=self.token.val, t='FUNCTIONS', start_pos=(self.token.pos-len(self.token.val)), end_pos=self.token.pos) 
      self.Expect(5)
      if (self.StartOf(3)):
